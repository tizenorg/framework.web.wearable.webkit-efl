...
#define CSS_MEDIAQUERY_PREFERRED_VIEWING_DISTANCE(macro) \
    macro(preferred_viewing_distance, "-tizen-preferred-viewing-distance")
#else
#define CSS_MEDIAQUERY_PREFERRED_VIEWING_DISTANCE(macro)
#endif

#if ENABLE(TIZEN_GEOMETRIC_SHAPE_CSS_MEDIA)
#define CSS_MEDIAQUERY_GEOMETRIC_SHAPE(macro) \
    macro(geometric_shape, "-tizen-geometric-shape")
#else
#define CSS_MEDIAQUERY_GEOMETRIC_SHAPE(macro)
#endif
...
#define CSS_MEDIAQUERY_NAMES_FOR_EACH_MEDIAFEATURE(macro) \
    ...
    CSS_MEDIAQUERY_PREFERRED_VIEWING_DISTANCE(macro) \
    CSS_MEDIAQUERY_VIEW_MODE(macro) \
    CSS_MEDIAQUERY_GEOMETRIC_SHAPE(macro)
