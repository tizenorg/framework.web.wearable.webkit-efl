...
public:
...
#if ENABLE(TIZEN_OVERFLOW_SCROLLBAR)
    void setHorizontalScrollbarLayer(TextureMapperLayer* layer) { m_horizontalScrollbarLayer = layer; }
    void setVerticalScrollbarLayer(TextureMapperLayer* layer) { m_verticalScrollbarLayer = layer; }
    TextureMapperLayer* horizontalScrollbarLayer() { return m_horizontalScrollbarLayer; }
    TextureMapperLayer* verticalScrollbarLayer() { return m_verticalScrollbarLayer; }
#endif
#if ENABLE(TIZEN_SCROLL_SCROLLABLE_AREA) && ENABLE(TIZEN_EDGE_EFFECT)
    ...
    enum EdgeEffectType {
        EdgeEffectTypeNone,
        EdgeEffectTypeTop,
        EdgeEffectTypeBottom,
        EdgeEffectTypeLeft,
        EdgeEffectTypeRight
    };
    void setVerticalEdgeEffectType(EdgeEffectType type) { m_verticalEdgeEffectType = type; }
    void setHorizontalEdgeEffectType(EdgeEffectType type) { m_horizontalEdgeEffectType = type; }
#endif
    ...
    void setFullScreenLayerForVideo(bool);
#endif
...
#endif
#if ENABLE(TIZEN_OVERFLOW_SCROLLBAR)
    void collectScrollableLayerRecursively(Vector<TextureMapperLayer*>&);
#endif
    ...
    IntSize findScrollSnapOffset(const IntSize&);
#endif
...
private:
    ...
    FloatSize boundScrollOffset(const FloatSize&);
#endif

#if ENABLE(TIZEN_EDGE_EFFECT)
    void paintEdgeEffectIfNeeded(const TextureMapperPaintOptions& options);
#endif
...
#if ENABLE(TIZEN_SCROLL_SNAP)
        Vector<float> horizontalSnapOffsets;
        Vector<float> verticalSnapOffsets;
#endif
    ...
    bool m_isScrollable;
#if ENABLE(TIZEN_OVERFLOW_SCROLLBAR)
    TextureMapperLayer* m_horizontalScrollbarLayer;
    TextureMapperLayer* m_verticalScrollbarLayer;
#endif
#if ENABLE(TIZEN_SCROLL_SCROLLABLE_AREA) && ENABLE(TIZEN_EDGE_EFFECT)
