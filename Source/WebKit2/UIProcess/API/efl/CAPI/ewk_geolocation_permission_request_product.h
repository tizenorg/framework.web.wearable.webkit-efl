...
#ifndef ewk_geolocation_permission_request_product_h
#define ewk_geolocation_permission_request_product_h
 ...
 *
 * @param request Ewk_Geolocation_Permission_Request object to get the infomation about geolocation permission request.
 * @param allow result about geolocation permission
 */
EAPI void ewk_geolocation_permission_reply(Ewk_Geolocation_Permission_Request* request, Eina_Bool allow);

#ifdef __cplusplus
}
#endif

#endif // ewk_geolocation_permission_request_product_h
