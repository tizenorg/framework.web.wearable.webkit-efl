...
/**
 * @brief Initializes WebKit's instance.
 *
 * @details initializes components needed by EFL,\n
...
/**
 * @brief Decreases a reference count of WebKit's instance, possibly destroying it.
 *
 * @details If the reference count reaches 0 WebKit's instance is destroyed.
 *
 * @since_tizen 2.3.1
 *
