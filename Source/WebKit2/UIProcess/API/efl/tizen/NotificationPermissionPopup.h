...
public:
    NotificationPermissionPopup(Ewk_Notification_Permission_Request*, const Ewk_Security_Origin* origin, const String& message);
    ~NotificationPermissionPopup() { };

    virtual void sendDecidedPermission(Evas_Object*, bool isDecided) OVERRIDE;

private:
    Ewk_Notification_Permission_Request* m_request;
};
