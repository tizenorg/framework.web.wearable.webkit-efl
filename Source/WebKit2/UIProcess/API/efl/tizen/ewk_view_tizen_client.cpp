...
static void decidePolicyForUserMediaPermissionRequest(WKPageRef, WKSecurityOriginRef origin, WKUserMediaPermissionRequestRef permissionRequest, const void *clientInfo)
{
#if ENABLE(TIZEN_MEDIA_STREAM)
