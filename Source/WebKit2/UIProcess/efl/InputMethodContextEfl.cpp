...
#if ENABLE(TIZEN_WEBKIT2_IMF_ADDITIONAL_CALLBACK)
void InputMethodContextEfl::onIMFInputPanelDeleteSurrounding(void* data, Ecore_IMF_Context* context, void* eventInfo)
{
    InputMethodContextEfl* inputMethodContext = static_cast<InputMethodContextEfl*>(data);
    ...
    inputMethodContext->m_view->page()->deleteSurroundingText(ev->offset, ev->n_chars);
}
